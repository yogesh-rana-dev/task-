...
import 'package:project/screen/card_scanner/controller/card_scanner_controller.dart';
import 'package:project/screen/card_scanner/widget/card_data_view.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const CustomText(AppStrings.cardScannerTitle, color: AppColors.cardBackground, fontWeight: FontWeight.w700),
      ),
      body: AnimatedBuilder(
        ...
        builder: (BuildContext context, _) {
          return SingleChildScrollView(
            ...
            child: Column(
              children: [
                // User clicks this to open camera, scan card image, then parse OCR result.
                PrimaryButton(
                ...
                // User clicks this to pick image from gallery, scan, then parse result.
                PrimaryButton(
                ...
                const SizedBox(height: 16),
                // If OCR/parse fails then error shows, otherwise extracted card details show.
                if (_controller.errorMessage != null)
                  CustomText(_controller.errorMessage!, color: AppColors.error)
                else if (_controller.extractedCardDetails != null)
                  CardDataView(cardDetails: _controller.extractedCardDetails!),
